...
function getData()
{
	...
	var slide_1_images = [{name:"3_2_2_2_A.jpg",
							x:10.05,
							y:69, 
							width:420.20,
							height:263.05,
	...
	var slide_2_images = [{name:"3_2_2_2_B.jpg",
							x:10.05,
							y:69, 
							width:420.20,
							height:263.05,
	...
	var slide_3_images = [{name:"3_2_2_2_C.jpg",
							x:10.05,
							y:69, 
							width:420.20,
							height:263.05,
	...
	var slide_4_images = [{name:"3_2_2_2_D.jpg",
							x:10.05,
							y:69, 
							width:420.20,
							height:263.05,
	...
	var slide_5_images = [{name:"3_2_2_2_E.jpg",
							x:10.05,
							y:69, 
							width:420.20,
							height:263.05,
